...
})();hljs.registerLanguage("json",e)})();/*! `python-repl` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("markdown",e)})();/*! `scss` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict"
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `swift` grammar compiled for Highlight.js 11.5.1 */
